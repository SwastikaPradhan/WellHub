...
export default function DailyProgress({ percentage = 85 }: DailyProgressProps) {
  ...
  return (
    ...
    >
      <h2 className="text-[20px] font-medium text-[#1e1e1e] mb-6 font-sans " style={{ fontFamily: 'Geist Mono, monospace' }}>
        Daily progress
      </h2>
      ...
      <p className="mt-6 text-[16px] font-medium text-gray-600 leading-relaxed" style={{ fontFamily: 'Geist Mono, monospace' }}>
        Keep working on your<br />
        nutrition and sleep
      </p>
